...
import lbrynet.schema.proto.fee_pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[lbrynet.schema.proto.fee_pb2.DESCRIPTOR,])
...
_METADATA.fields_by_name['fee'].message_type = lbrynet.schema.proto.fee_pb2._FEE
