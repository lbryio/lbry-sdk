...
class TestReflector(unittest.TestCase):
    def setUp(self):
        ...
        client_blob_manager = BlobManager.BlobManager(client_hash_announcer,
                                                          client_db_dir,
                                                          client_storage)
        server_blob_manager = BlobManager.BlobManager(server_hash_announcer,
                                                          server_db_dir,
                                                          server_storage)
        ...
        self.client_stream_info_manager = EncryptedFileMetadataManager(self.client_session.storage)
        ...
        self.server_stream_info_manager = EncryptedFileMetadataManager(self.server_session.storage)
